...
В папката `docs/` ще намерите кратко обяснение на основни React и JavaScript концепции,
използвани в проекта (напр. компоненти, `useState`, обработка на събития, `fetch` и JSX синтаксис).

Файлът има за цел да улесни разбирането на кода, без да навлиза в детайли извън нужните за този demo:

- `docs/react-and-js-basics.md`
